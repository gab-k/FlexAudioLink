"""
Throughput calculator for FlexLink PROP ping-pong link.
...
Default payload size is 180 bytes (PROP_TEST_MODE_PAYLOAD_LEN).
"""
...
def main():
    parser = argparse.ArgumentParser(description="FlexLink PROP throughput calculator")
